import {addTaskTC, getTasksTC, removeTaskTC, tasksReducer, TasksStateType, updateTaskTC} from './tasks-reducer';
...
test('correct task should be deleted from correct array', () => {
    ...
    const action = removeTaskTC.fulfilled({taskId: '2', todolistId: todoId2}, '', {taskId: '2', todolistId: todoId2})
...
test('status of specified task should be changed', () => {
    ...
    const action = updateTaskTC.fulfilled({todolistId: todoId2, taskId: '2', model}, '', {
        todolistId: todoId2,
        taskId: '2',
        model
    })
...
test('property with todolistId should be deleted', () => {
    ...
    const action = removeTodolistTC.fulfilled(todoId2, '', todoId2)
    const endState = tasksReducer(startState, action)
